...
public class ControleDados {
	...
	public boolean inserirEditarPerfumes(String[] dadosPerfume) {
		...
		if (!dadosPerfume[3].matches("[0-9]+") || !dadosPerfume[5].matches("[0-9]+")) {
			return false;
		} else {
	...
	public boolean removerPerfumes(int i) {
		...
		if (i == (d.getQtdPerfumes() - 1)) { // O cliente a ser removido está no final do array
	...
	public boolean inserirEditarDesodorantes(String[] dadosDesodorante) {
		...
		if (!dadosDesodorante[3].matches("[0-9]+") || !dadosDesodorante[5].matches("[0-9]+")) {
			return false;
		} else {
	...
	public boolean removerDesodorantes(int i) {
		...
		if (i == (d.getQtdDesodorantes() - 1)) { // O cliente a ser removido está no final do array
	...
	public boolean inserirEditarHidratantes(String[] dadosHidratante) {
		...
		if (!dadosHidratante[3].matches("[0-9]+") || !dadosHidratante[5].matches("[0-9]+")) {
			return false;
		} else {
	...
	public boolean removerHidratantes(int i) {
		...
		if (i == (d.getQtdHidratantes() - 1)) { // O cliente a ser removido está no final do array
	...
	public boolean removerVendas(int i) {
		...
		if (i == (d.getQtdVendas() - 1)) { // O cliente a ser removido está no final do array
